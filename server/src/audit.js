...
export async function logAudit({ actorDiscordId = null, action, targetType = null, targetId = null, metadata = {}, ip = null }) {
  await db.prepare(`
...
export async function writeAccountHistory({ accountId, actorDiscordId, action, metadata = {} }) {
  await db.prepare(`
